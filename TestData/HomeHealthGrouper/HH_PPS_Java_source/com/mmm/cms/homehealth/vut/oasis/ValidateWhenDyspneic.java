 ...
 */
public class ValidateWhenDyspneic extends AbstractClinicalItemValidator implements RecordItemValidatorIF {
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits) {
        ...
        if (ValidateUtils.isValidValue(record.getASSMT_REASON(), AbstractItemValidator.ASSESSMENT_1_3_4_5_9_ONLY)) {
            if (!ValidateUtils.isValidValue(record.getWHEN_DYSPNEIC(), 
                ...
                edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                    new HHOasisDataItem(HomeHealthRecord_C1_IF.OASIS_C1_ITEM_M1400_WHEN_DYSPNEIC, record.getWHEN_DYSPNEIC())));
            }
        }
    ...
    public String getDescription() {
        return "Validates When Dyspneic for edits: 3060";
    }
