 ...
 */
public class ValidateDrugRegimenReview_OASIS_D extends AbstractClinicalItemValidator implements RecordItemValidatorIF {
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits) {
        ...
        final String drugRegemine = ((HomeHealthRecord_D_IF) record).getDRUG_RGMN_RVW();
        ...
        if (ValidateUtils.isValidValue(assessmentReason, AbstractItemValidator.ASSESSMENT_1_3_ONLY)) {
            ...
            if (!ValidateUtils.isValidValue(drugRegemine,
                ...
                edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                        new HHOasisDataItem(HomeHealthRecord_D_IF.OASIS_D_ITEM_M2001_DRUG_RGMN_RVW, drugRegemine)));
            }
            ...
            if (ValidateUtils.isValidValue(drugRegemine,
                ...
                if (ValidateUtils.isValidValue(injectMeds,
                    ...
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4431,
                            new HHOasisDataItem(HomeHealthRecord_D_IF.OASIS_D_ITEM_M2001_DRUG_RGMN_RVW, drugRegemine)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4431,
                            new HHOasisDataItem(HomeHealthRecord_D_IF.OASIS_D_ITEM_M2030_CRNT_MGMT_INJCTN_MDCTN, injectMeds)));
                }
            }
