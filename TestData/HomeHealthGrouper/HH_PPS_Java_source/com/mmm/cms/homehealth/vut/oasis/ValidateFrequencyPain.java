 ...
 */
public class ValidateFrequencyPain extends AbstractClinicalItemValidator implements RecordItemValidatorIF {
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits) {
        ...
        if (ValidateUtils.isValidValue(record.getASSMT_REASON(), AbstractItemValidator.ASSESSMENT_1_3_4_5_9_ONLY)) {
            if (!ValidateUtils.isValidValue(record.getPAIN_FREQ_ACTVTY_MVMT(), 
                ...
                edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                        new HHOasisDataItem(HomeHealthRecord_C1_IF.OASIS_C1_ITEM_M1242_PAIN_FREQ_ACTVTY_MVMT, record.getPAIN_FREQ_ACTVTY_MVMT())));
            }
        }
    ...
    public String getDescription() {
        return "Validates Frequency Pain Management for edits: 3060";
    }
