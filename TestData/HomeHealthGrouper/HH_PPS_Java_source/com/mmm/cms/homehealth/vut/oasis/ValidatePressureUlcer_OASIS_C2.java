...
public class ValidatePressureUlcer_OASIS_C2 extends AbstractClinicalItemValidator implements RecordItemValidatorIF {
     ...
     */
    public ValidatePressureUlcer_OASIS_C2() {
        super(HomeHealthRecord_C2_IF.class);
    }
    ...
    public List<OasisEditIF> getEditIdsUsed() {
        return super.getEditIdsUsed_base(OasisEditsEN.EDIT_3060, OasisEditsEN.EDIT_3010,
                OasisEditsEN.EDIT_4131, OasisEditsEN.EDIT_4141,
                OasisEditsEN.EDIT_4151, OasisEditsEN.EDIT_4161, 
                OasisEditsEN.EDIT_4170, OasisEditsEN.EDIT_4211, 
                OasisEditsEN.EDIT_5110, OasisEditsEN.EDIT_5121, 
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits) {
        ...
        if (ValidateUtils.isValidValue(assessmentReason, AbstractItemValidator.ASSESSMENT_1_3_4_5_9_ONLY)) {
            if (record instanceof HomeHealthRecord_C2_IF) {
                final HomeHealthRecord_C2_IF recordC = (HomeHealthRecord_C2_IF) record;
                ...
                if (!ValidateUtils.isEmpty(UNHLD_STG2_PRSR_ULCR) && !ValidateUtils.isNumeric(UNHLD_STG2_PRSR_ULCR)) {
                    ...
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1306_UNHLD_STG2_PRSR_ULCR, UNHLD_STG2_PRSR_ULCR)));
                }
                ...
                if (!ValidateUtils.isEmptyCaret(NBR_PRSULC_STG2) && !isValueInRange01To99(NBR_PRSULC_STG2)) {
                    ...
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3010,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1, NBR_PRSULC_STG2)));
                }
                if (!ValidateUtils.isEmptyCaret(NBR_PRSULC_STG3) && !isValueInRange01To99(NBR_PRSULC_STG3)) {
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3010,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1, NBR_PRSULC_STG3)));
                }
                if (!ValidateUtils.isEmptyCaret(NBR_PRSULC_STG4) && !isValueInRange01To99(NBR_PRSULC_STG4)) {
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3010,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG4_C1, NBR_PRSULC_STG4)));
                }
                if (!ValidateUtils.isEmptyCaret(NSTG_CVRG) && !isValueInRange01To99(NSTG_CVRG)) {
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3010,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NSTG_CVRG_E1, NSTG_CVRG)));
                }
                if (!ValidateUtils.isEmptyCaret(NSTG_DEEP_TISUE) && !isValueInRange01To99(NSTG_DEEP_TISUE)) {
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3010,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NSTG_DEEP_TSUE_F1, NSTG_DEEP_TISUE)));
                }

                if (!ValidateUtils.isEmptyCaret(NSTG_DRSG) && !isValueInRange01To99(NSTG_DRSG)) {
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3010,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NSTG_DRSG_D1, NSTG_DRSG)));
                }
                ...
                if (isRFA_1_3_9
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1320_STUS_PRBLM_PRSR_ULCR, STUS_PRBLM_PRSR_ULCR)));
                }
                ...
                if (!ValidateUtils.isValidValue(STG_PRBLM_ULCER, 
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1324_STG_PRBLM_ULCER, STG_PRBLM_ULCER)));
                }
                ...
                if ("0".equals(UNHLD_STG2_PRSR_ULCR)) {
                    ...
                    if (ValidateUtils.isEmpty(NBR_PRSULC_STG2) || edits.isEditPresent(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1)
                            || ValidateUtils.isEmpty(NBR_PRSULC_STG3)|| edits.isEditPresent(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1)
                            || ValidateUtils.isEmpty(NBR_PRSULC_STG4)|| edits.isEditPresent(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG4_C1)
                            || ValidateUtils.isEmpty(NSTG_CVRG)|| edits.isEditPresent(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NSTG_CVRG_E1)
                            || ValidateUtils.isEmpty(NSTG_DEEP_TISUE)|| edits.isEditPresent(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NSTG_DEEP_TSUE_F1)
                            || ValidateUtils.isEmpty(NSTG_DRSG)|| edits.isEditPresent(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NSTG_DRSG_D1)) {
                        count++;
                        edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_5121,
                                new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1306_UNHLD_STG2_PRSR_ULCR, UNHLD_STG2_PRSR_ULCR)));
                        edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_5121,
                                new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1, NBR_PRSULC_STG2)));
                        edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_5121,
                ...
                if (ValidateUtils.isValidValue(NBR_PRSULC_STG1, ValidateUtils.ARRAY_DOUBLE_0)
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4211,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1322_NBR_PRSULC_STG1, NBR_PRSULC_STG1)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4211,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1, NBR_PRSULC_STG2)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4211,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1, NBR_PRSULC_STG3)));
                ...
                if (intStage2 == 0 && intStage3 == 0 && intStage4 == 0 && intNonStageCovering == 0
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4131,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1, NBR_PRSULC_STG2)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4131,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1, NBR_PRSULC_STG3)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4131,
                ...
                if ((intStage2 > 0 || intNonStageDeepTissue > 0)
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4141,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1, NBR_PRSULC_STG2)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4141,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1, NBR_PRSULC_STG3)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4141,
                ...
                if ((intStage3 > 0 || intStage4 > 0)
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4151,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1, NBR_PRSULC_STG3)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4151,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG4_C1, NBR_PRSULC_STG4)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4151,
                ...
                if (intNonStageCovering > 0 && intStage2 == 0 && intStage3 == 0
                    ...
                    count++;
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4161,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG2_A1, NBR_PRSULC_STG2)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4161,
                            new HHOasisDataItem(HomeHealthRecord_C2_IF.OASIS_C2_ITEM_M1311_NBR_PRSULC_STG3_B1, NBR_PRSULC_STG3)));
                    edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4161,
