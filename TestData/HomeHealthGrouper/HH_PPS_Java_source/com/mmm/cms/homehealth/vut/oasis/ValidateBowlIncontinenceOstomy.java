 ...
 */
public class ValidateBowlIncontinenceOstomy extends AbstractClinicalItemValidator implements RecordItemValidatorIF {
        ...
        if (ValidateUtils.isValidValue(assessmentReason, AbstractItemValidator.ASSESSMENT_1_3_4_5_9_ONLY)) {
            ...
            if (ValidateUtils.isValidValue(ostomy, ValidateUtils.ARRAY_DOUBLE_0, 
                ...
                if (NOT_APPLICABLE.equals(bwlIncont)) {
                    if (!ValidateUtils.isValidValue(ostomy, ValidateUtils.ARRAY_DOUBLE_1, ValidateUtils.ARRAY_DOUBLE_2)) {
                        ...
                        edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_4370,
                                new HHOasisDataItem(HomeHealthRecord_C1_IF.OASIS_C1_ITEM_M1620_BWL_INCONT, bwlIncont)));
                    }
                ...
                edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                        new HHOasisDataItem(HomeHealthRecord_C1_IF.OASIS_C1_ITEM_M1630_OSTOMY, ostomy)));
            }
        }
