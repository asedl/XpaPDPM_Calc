 ...
 */
public class ValidateCurrentBathing extends AbstractFunctionalItemValidator implements RecordItemValidatorIF {
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits) {
        ...
        if (ValidateUtils.isValidValue(record.getASSMT_REASON(), AbstractItemValidator.ASSESSMENT_1_3_4_5_9_ONLY)) {
            if (!ValidateUtils.isValidValue(record.getCRNT_BATHG(), 
                ...
                edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                        new HHOasisDataItem(HomeHealthRecord_C1_IF.OASIS_C1_ITEM_M1830_CRNT_BATHG, record.getCRNT_BATHG())));
            }
        }
    ...
    public String getDescription() {
        return "Validates Current Bathin for edits: 3060";
    }
