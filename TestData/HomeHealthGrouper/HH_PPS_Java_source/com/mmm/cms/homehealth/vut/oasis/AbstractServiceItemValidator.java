 ...
 */
public abstract class AbstractServiceItemValidator extends AbstractItemValidator {

    /**
     * creates with a default record class of HomeHealthRecordIF
     */
    public AbstractServiceItemValidator() {
    }
     ...
     * @param clazz 
     */
    protected AbstractServiceItemValidator(Class clazz) {
        super(clazz);
    }
     ...
     * issues, it sets the Service issue flag to true
     * 
     * @param record
     * @param edits
     * @param dataValidity
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits, DataValidityFlagIF dataValidity) {
        ...
        if (count > 0) {
            dataValidity.setServiceIssue(true);
        }
        return count;
    }
