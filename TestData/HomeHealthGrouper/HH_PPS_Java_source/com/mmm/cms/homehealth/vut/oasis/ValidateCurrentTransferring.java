 ...
 */
public class ValidateCurrentTransferring extends AbstractFunctionalItemValidator implements RecordItemValidatorIF {
    ...
    public int validate(HomeHealthRecordIF record, CollectionValidationEditsIF edits) {
        ...
        if (ValidateUtils.isValidValue(record.getASSMT_REASON(), AbstractItemValidator.ASSESSMENT_1_3_4_5_9_ONLY)) {
            if (!ValidateUtils.isValidValue(record.getCRNT_TRNSFRNG(), 
                ...
                edits.add(new OasisValidationEdit(OasisEditsEN.EDIT_3060,
                        new HHOasisDataItem(HomeHealthRecord_C1_IF.OASIS_C1_ITEM_M1850_CRNT_TRNSFRNG, record.getCRNT_TRNSFRNG())));
            }
        }
    ...
    public String getDescription() {
        return "Validates Transferring for edits: 3060";
    }
