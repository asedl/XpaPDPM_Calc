 ...
 * diagnosis codes have changed from PMT_... to OTH_... Both will go away as 
 * we do away with the optional payment fields, but are still available for 
 * historical reasons. Due to this, the get/setOTH_... methods are just delegation
 * methods to/from the get/setPMT_ methods
 * 
 * @author 3M Health Information Systems for CMS Home Health
 */
public class Oasis_C1_Record_2_12 extends Oasis_C_Record implements HomeHealthRecord_C1_IF {

    @Override
    public RecordType getRecordType() {
        return RecordType.OASIS_C1_ICD_10;
    }
    ...
    public String toString() {
        ...
        buffer.append(",M1320_STUS_PRBLM_PRSR_ULCR=");
        buffer.append(getSTUS_PRBLM_PRSR_ULCR());
