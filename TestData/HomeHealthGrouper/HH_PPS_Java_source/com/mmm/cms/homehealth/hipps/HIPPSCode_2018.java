 ...
 */
public class HIPPSCode_2018 extends HIPPSCode implements Serializable{
	...
	static {
		...
		*/
		...
		threshold.addSeverityLimit(8, 15, 'G');
	...
	public HIPPSCode_2018() {
	}

	public HIPPSCode_2018(HomeHealthRecordIF record, HomeHealthRecordValidatorIF validator, PointsScoringEquationsIF clinicalScore, PointsScoringEquationsIF functionalScore, int nrsScore) {
