 ...
 * pertain to the Non Routine Supplies scoring model.
 *
 * @author 3M Health Information Systems for CMS Home Health
 */
public class HomeHealthRecordNRSValidator_3110 extends AbstractBaseValidator_v3110 {
	...
	public boolean validateDiagnosisCodes(HomeHealthRecordIF record, Collection<HomeHealthEventListenerIF> listeners) {
		...
		for (idx = 0; idx < 6; idx++) {
			...
			if (code.isValidForScoring()) {
				...
				} else if (record.getOptionalDiagnosisCode3(idx).isValidCode()
