 ...
 */
public enum HH_PPS_OasisC1EditsEN implements OasisEditIF {

    EDIT_70000(70000, Level.SEVERE, OasisEditTypeEN.CONSISTENCY, HomeHealthRecord_C1_IF.VALUE_SPEC_VRSN_CD, "Invalid Diagnosis Code."),
    EDIT_70010(70010, Level.SEVERE, OasisEditTypeEN.CONSISTENCY, HomeHealthRecord_C1_IF.VALUE_SPEC_VRSN_CD, "Unacceptable Primary Diagnosis code."),
    EDIT_70020(70020, Level.SEVERE, OasisEditTypeEN.CONSISTENCY, HomeHealthRecord_C1_IF.VALUE_SPEC_VRSN_CD, "Unacceptable Primary Diagnosis code due to Manifestation as Primary Diagnosis."),
    EDIT_70030(70030, Level.WARNING, OasisEditTypeEN.CONSISTENCY, HomeHealthRecord_C1_IF.VALUE_SPEC_VRSN_CD, "Manifestation code without valid Etiology pairing."),
    /*
     * new for v4115
    */
    EDIT_70040(70040, Level.WARNING, OasisEditTypeEN.CONSISTENCY, HomeHealthRecord_C1_IF.VALUE_SPEC_VRSN_CD, "Missing optional payment pairing."),
    EDIT_70050(70050, Level.WARNING, OasisEditTypeEN.CONSISTENCY, HomeHealthRecord_C1_IF.VALUE_SPEC_VRSN_CD, "Not valid manifestation code.");
    ...
    private HH_PPS_OasisC1EditsEN(int id, Level serverityLevel, OasisEditTypeEN type, String versionActiveTo, String description) {
        this.id = id;
     ...
     * null
     */
    public static HH_PPS_OasisC1EditsEN getType(String description) {
        final HH_PPS_OasisC1EditsEN values[] = HH_PPS_OasisC1EditsEN.values();
        HH_PPS_OasisC1EditsEN value = null;
     ...
     */
    public static HH_PPS_OasisC1EditsEN getType(int id) {
        final HH_PPS_OasisC1EditsEN values[] = HH_PPS_OasisC1EditsEN.values();
        HH_PPS_OasisC1EditsEN value = null;
